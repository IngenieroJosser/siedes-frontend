      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[1fr_330px]">
        ...
        <div className="space-y-4">
          <InlineNotice tone="warning" title="Interpretación">
            El piloto predictivo vigente no estima riesgo individual. Este valor pertenece al modelo de datos operativo heredado y no debe interpretarse como salida del modelo SIEDES. Consulta el riesgo oficial por institución en la sección “Riesgo institucional”.
          </InlineNotice>
